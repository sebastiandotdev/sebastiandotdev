...
export const socialSite = [
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/sebastiandotdev',
        Icon: IconLinkedIn
    },
    {
        name: 'Github',
...
export const projects = [
    ...
    {title: 'Open UI', description: 'A design system built with TailwindCSS and Radix UI.', github: 'https://github.com/openlitedotdev/ui', demo: 'https://ui.openlabs.online', tags: ['React', 'TailwindCSS']},

    {title: 'Shopped', description: 'Shopped. A store built with design system Open UI.', github: 'https://github.com/openlitedotdev/shopped', demo: 'https://store.openlabs.online', tags: ['React', 'TailwindCSS', 'Open UI']},
]

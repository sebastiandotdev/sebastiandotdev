...
export function CarouselPrevious(props: VoidProps<ComponentProps<typeof Button>>) {
...
export function CarouselNext(props: VoidProps<ComponentProps<typeof Button>>) {
  const merge = mergeProps<VoidProps<ComponentProps<typeof Button>[]>>(
    { variant: 'outline', size: 'icon' },
    props,
  )

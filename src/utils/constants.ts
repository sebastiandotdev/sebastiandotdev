...
export const projects = [
  {
    ...
    github: 'https://github.com/openlitedotdev/ui',
    demo: 'https://ui.openlabs.online',
    tags: ['React', 'TailwindCSS'],
  },

  {
    title: 'Shopped',
    description: 'Shopped. A store built with design system Open UI.',
    github: 'https://github.com/openlitedotdev/shopped',
    demo: 'https://store.openlabs.online',
    tags: ['React', 'TailwindCSS', 'Open UI'],
  },
]

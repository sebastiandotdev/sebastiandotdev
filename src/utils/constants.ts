...
export const socialSite = [
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/sebastiandottop/',
        Icon: IconLinkedIn
    },
    {
        name: 'Github',
...
export const projects = [
    ...
    {title: 'Open UI', description: 'A design system built with TailwindCSS and Shadcn.', github: 'https://github.com/openlite-dev/openui', demo: 'https://openlabs.online/ui', tags: ['React', 'TailwindCSS', 'Shadcn']},

    {title: 'Shopped', description: 'Shopped. A store built with design system Open UI.', github: 'https://github.com/openlite-dev/shopped', demo: 'https://shopped.pages.dev/', tags: ['React', 'TailwindCSS', 'Shadcn']},
]

export default function ContactSection() {
  return (
    <form id="contact" class="max-w-lg mx-auto grid gap-1 relative">
      <div class="p-4 max-w-2xl mx-auto relative w-full md:pt-0">
        <h2 class="text-4xl font-bold text-center dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-50 dark:to-neutral-400 dark:bg-opacity-50">
          Get In Touch
        </h2>
        <p class="mt-4 font-normal text-base max-w-lg text-center mx-auto">
